...
const data = [
  {
    ...
    issues: [
      ...
      },
      {
        ...
        descriptionTittle: 'Ideal for aging or high-labor staff',
  ...
  },
  {
    ...
    issues: [
      ...
      },
      {
        ...
        icon: <GiShield className="text-xl text-amber-400" />,
        descriptionTittle: 'Ideal for vets in direct animal contact',
    ...
    issues: [
      {
        ...
        icon: <GiHealthNormal className="text-xl text-amber-400" />,
        descriptionTittle: 'Ideal for drivers & loaders',

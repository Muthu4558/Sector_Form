      ...
      <div className="max-w-7xl mx-auto space-y-20">
        ...
        >
          ...
          <p className="text-lg font-medium text-gray-700 mb-2">
            1 <span className="text-green-600 font-bold">FREE</span> On-site Wellness Workshop for the first 5 mining companies that register
          </p>
          <p className="text-sm text-gray-600 font-semibold">
            Includes <span className="font-semibold text-green-700">basic screenings + awareness session</span> for up to 50 employees
          </p>

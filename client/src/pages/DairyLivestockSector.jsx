...
import HeroSection from '../components/DairyLivestock-sector/SectionHeader';
import HealthPackagesAccordion from '../components/DairyLivestock-sector/HealthPackagesAccordion';
import WellnessPackages from '../components/DairyLivestock-sector/WellnessPackages';
import InHouseHealthcare from '../components/DairyLivestock-sector/InHouseHealthcare';
import WhatWillYouGain from '../components/DairyLivestock-sector/UniqueWhyNizcareSection';    
import Footer from '../components/DairyLivestock-sector/Footer';
import TourismHealthChallenges from '../components/DairyLivestock-sector/TourismHealthChallenges';

const DairyLivestockSector = () => {
...
export default DairyLivestockSector;
...
import HeroSection from '../components/Chemical-sector/SectionHeader';
import HotelHealthChallenges from '../components/Chemical-sector/HotelHealthChallenges';
import HealthPackagesAccordion from '../components/Chemical-sector/HealthPackagesAccordion';
import WellnessPackages from '../components/Chemical-sector/WellnessPackages';
import InHouseHealthcare from '../components/Chemical-sector/InHouseHealthcare';
import WhatWillYouGain from '../components/Chemical-sector/UniqueWhyNizcareSection';    
import Footer from '../components/Chemical-sector/Footer';

const ChemicalSector = () => {
